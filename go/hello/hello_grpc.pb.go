...
type HelloServiceClient interface {
	...
	SayHelloCustomErr(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error)
}
...
func (c *helloServiceClient) SayHelloCustomErr(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
	err := c.cc.Invoke(ctx, "/hello.HelloService/SayHelloCustomErr", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServiceServer interface {
	...
	SayHelloCustomErr(context.Context, *HelloReq) (*HelloResp, error)
...
func (UnimplementedHelloServiceServer) SayHelloCustomErr(context.Context, *HelloReq) (*HelloResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHelloCustomErr not implemented")
}
...
func _HelloService_SayHelloCustomErr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServiceServer).SayHelloCustomErr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.HelloService/SayHelloCustomErr",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SayHelloCustomErr(ctx, req.(*HelloReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SayHelloCustomErr",
			Handler:    _HelloService_SayHelloCustomErr_Handler,
		},
	},
